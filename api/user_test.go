...
func requireBodyMatchUser(t *testing.T, body *bytes.Buffer, user db.User) {
	...
	require.NoError(t, err)
	require.Equal(t, user.Username, gotUser.Data.Username)
	require.Equal(t, user.FullName, gotUser.Data.FullName)
	require.Equal(t, user.Email, gotUser.Data.Email)
	require.Empty(t, gotUser.Data.HashedPassword)
}
