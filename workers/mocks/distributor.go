...
// Source: github.com/santinofajardo/simpleBank/workers (interfaces: TaskDistributor)
...
import (
	...
	workers "github.com/santinofajardo/simpleBank/workers"
)
...
func (m *MockTaskDistributor) DistributeTaskSendVerifyEmail(arg0 context.Context, arg1 *workers.PayloadSendVerifyEmail, arg2 ...asynq.Option) error {
	m.ctrl.T.Helper()
